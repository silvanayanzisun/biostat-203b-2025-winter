...
model stacking(logistic + random forest + xgboost) gives an AUC of 
xgboost provides the best result so far. The most important features predicting los_long are:
xgboost provides the best performance, and logistic regression provides the best interpretability.