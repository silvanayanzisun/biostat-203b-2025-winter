...
```{r}
demographics_summary <- mimic_icu_cohort %>%
...
```{r}
los_demo_race <- ggplot(mimic_icu_cohort, aes(x=race, y=los)) +
  geom_bar(stat = "identity", fill = "steelblue") +
   labs(
    title = "Length of ICU stay `los` vs demographic variables",
