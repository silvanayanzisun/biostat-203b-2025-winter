...
**Solution:** I choose to use apache arrow with dplyr to answer this question. First, I downloaded the unzipped chartevnts.csv from box folder, then I ingest it with open_dataset function and output a parquet file. Next, I created a tibble collecting the dplyer-filtered dataset. Finally, I showed the nrow and head the first 10 rows.
...
chartevents_tibble <- arrow::open_dataset("chartevents_parquet", format = "parquet") %>%
