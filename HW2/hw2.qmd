...
**Solution:** There are 514267 lines in the new filtered file excluding the header. It takes around 0.5 seconds for `read_csv` to ingest the filtered csv.
```{bash}
#| eval: false
zcat< ~/mimic/hosp/labevents.csv.gz | awk -F',' '
NR==1 || $5 ~ /50912|50971|50983|50902|50882|51221|51301|50931/ { 
    print $2 "," $5 "," $7 "," $10 
